                            ...
                            <ScrollView style={globalStyles.scrollView}>
                                ...
                                <View style={[globalStyles.buttonContainer,{alignItems:'flex-start',margin:5}]}>
                                    <TouchableOpacity onPress={closeModal}>
                                        <Text style={[{fontSize: 50, borderWidth:5, borderRadius: 25, paddingHorizontal:5, paddingBottom:10 }]}>↩</Text>
                                    </TouchableOpacity>
                                </View>
                                <Text style={[globalStyles.heading,{paddingRight: 10}]} >בחירת רגשות</Text>
